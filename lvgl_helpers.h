...
#define DISP_BUF_SIZE  (LV_HOR_RES_MAX * LV_VER_RES)
...
#define DISP_BUF_SIZE ((LV_VER_RES_MAX * LV_VER_RES) / 8) // 5KB
#elif defined (CONFIG_LV_TFT_DISPLAY_CONTROLLER_UC8151D)
#define DISP_BUF_SIZE ((LV_VER_RES_MAX * LV_VER_RES) / 8) // 2888 bytes
